...
% Otherwise generate    
    ...
    % Save
    save('datamask1.mat','datamask1')
    save('datamask12.mat','datamask12')
    save('datamask60.mat','datamask60')

end

%% Interpolated datamasks for other resolutions
% Load if already calculated
if exist('datamask2.mat','file')
    load('datamask2.mat')
    load('datamaskERA5.mat')
...
% Otherwise generate    
    ...
    % Save
    save('datamask2.mat','datamask2')
    save('datamaskERA5.mat','datamaskERA5')
