...
if exist('lat_UK_RCM.mat','file')
load('lat_UK_CPM.mat')
load('lat_UK_RCM.mat')
load('lat_UK_GCM.mat')
load('long_UK_CPM.mat')
load('long_UK_RCM.mat')
load('long_UK_GCM.mat')
else
...
%     lat_UK_HadUK1 = ncread([HadUKdatadir,'1km/tas_hadukgrid_uk_1km_mon_198101-198112.nc'],'latitude');
    long_UK_HadUK1 = ncread(['tas_hadukgrid_uk_1km_mon_198101-198112.nc'],'longitude');
    lat_UK_HadUK1 = ncread(['tas_hadukgrid_uk_1km_mon_198101-198112.nc'],'latitude');
